...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('filesharing', '0010_filepermissionmodel_permission'),
    ...
    operations = [
        migrations.AlterField(
            ...
            name='file',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permissions', to='filesharing.filemodel'),
        ),
        migrations.AlterField(
            model_name='filepermissionmodel',
            name='user',
